        ...
        <div className="min-h-screen bg-gradient-to-b from-brandBackground to-brandSecondary">
            ...
            <div className="flex justify-center w-full h-auto">
                <Button
                    ...
                    className="bg-brandAccent hover:bg-opacity-90 text-brandPrimary text-2xl px-8 py-4 mb-12 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
                >
