...
Pamiętaj, że najważniejsze jest, abyś czuł się komfortowo i był sobą. Prawdziwa magia dzieje się wtedy, gdy dwoje autentycznych ludzi spotyka się i tworzy własną, unikalną historię. Powodzenia w tworzeniu Waszej magicznej opowieści!
  ...
  comments: [
    {
      id: 1,
      author: "RomantycznyMarzyciel",
      avatar: "/placeholder.svg?height=40&width=40&text=RM",
      content: "Świetne porady! Szczególnie podoba mi się pomysł z piknikiem pod gwiazdami. Muszę to wypróbować na mojej następnej randce!",
      date: new Date('2023-06-16'),
      likes: 15
    },
    {
      id: 2,
      author: "Sceptyczna_Sandra",
      avatar: "/placeholder.svg?height=40&width=40&text=SS",
      content: "Hmm, nie jestem przekonana co do tego 'magicznego triku'. Czy to nie brzmi trochę dziecinnie? Wolałabym po prostu szczerą rozmowę.",
      date: new Date('2023-06-17'),
      likes: 7
    },
    {
      id: 3,
      author: "PrzygodowyPawel",
      avatar: "/placeholder.svg?height=40&width=40&text=PP",
      content: "Uwielbiam pomysł z warsztatami sushi! To świetna okazja, żeby się pośmiać i poznać się w luźnej atmosferze. Dzięki za inspirację!",
      date: new Date('2023-06-18'),
      likes: 22
    },
    {
      id: 4,
      author: "Nieśmiała_Natalia",
      avatar: "/placeholder.svg?height=40&width=40&text=NN",
      content: "Te porady dodały mi odwagi. Zawsze stresowałam się pierwszymi randkami, ale teraz czuję, że mam kilka fajnych pomysłów do wykorzystania. Dziękuję!",
  ...
  const handleAddComment = () => {
    if (newComment.trim()) {
      const newCommentObj = {
        ...
        author: "Nowy_Użytkownik",
        avatar: "/placeholder.svg?height=40&width=40&text=NU",
        content: newComment,
        date: new Date(),
        likes: 0
      }
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-100 to-pink-100">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-2xl font-semibold mb-6">Komentarze ({comments.length})</h3>
          ...
          <div className="mt-8">
            <h4 className="text-xl font-semibold mb-4">Dodaj komentarz</h4>
            <textarea
              className="w-full p-2 border border-gray-300 text-black rounded-md mb-4"
              rows={4}
              value={newComment}
              onChange={(e) => setNewComment(e.target.value)}
              placeholder="Co myślisz o tym artykule? Twój komentarz może pomóc innym!"
            ></textarea>
