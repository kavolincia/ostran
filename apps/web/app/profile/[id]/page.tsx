...
export default function ProfilePage({ params }: { params: { id: string } }) {
    ...
    const similarProfiles = profilesData
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              /> */}
                                ...
                                <div
                                    className="cursor-pointer absolute top-4 right-4 flex items-center bg-brandBackground text-white p-4 rounded-full"
                        ...
                        <CardContent className="p-6">
                            ...
                            {profile.facebook && (
                                <Link
                                    ...
                                    className="my-4 underline hover:text-brandBackground duration-150 transition flex items-center gap-x-4"
                                >
                                    <svg
                                        className="w-8 h-8"
                                        role="img"
                        ...
                        <CardFooter className="flex justify-between p-6">
                            <div className="flex flex-col md:flex-row md:gap-x-4 gap-y-4 items-center w-full">
                                ...
                                <Button
                                    ...
                                    onClick={() => setModalOpen(true)}
                                >
                                    <Phone className="mr-2 h-4 w-4" /> Poproś o
                                    numer
                                </Button>
                            </div>
                        </CardFooter>
                    ...
                    <Card className="mt-6">
                        <CardContent className="p-6">
                            ...
                            <p className="text-gray-600 mb-4">
                                Bądź na bieżąco z aktywnością {profile.name}
                            </p>
                            <Input
                                type="email"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {similarProfiles.map((similarProfile) => (
                                    <Link
                                        ...
                                        href={`/profile/${similarProfile.id}`}
                                    >
