                ...
                <div className="flex flex-col lg:flex-row items-center justify-between mb-12">
                    <div className="lg:w-full mb-8 lg:mb-0 px-12">
                        ...
                        <p className="mb-6 text-lg leading-relaxed">
                            Wyobraź sobie, że za kilka tygodni możesz siedzieć w
                            przytulnej kawiarni, patrząc w oczy osobie, która
                            sprawia, że Twoje serce bije szybciej. Brzmi jak
                            marzenie? Z nami to możliwe!
                        </p>
